...
const ui = {
  es: {
    ...
    heroDescription: "Cambios, aprendizajes y momentos especiales en un solo lugar 🐈", viewStory: "Ver su historia",
  ...
  en: {
    ...
    heroDescription: "Changes, discoveries and special moments, all in one place 🐈", viewStory: "View her story",
